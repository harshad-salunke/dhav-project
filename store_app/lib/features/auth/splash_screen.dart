...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          Positioned.fill(child: CustomPaint(painter: _DiagonalLinesPainter(c.diagonalLines))),
          Center(
                  ...
                  ScaleTransition(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: AppColors.primary.withValues(alpha: 0.5), blurRadius: 32, spreadRadius: 8),
                        ],
                      ),
...
class _DiagonalLinesPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant _DiagonalLinesPainter old) => old.lineColor != lineColor;
}
